                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    if (user.isEmailVerified()) {
                                        ...
                                        SharedPreferences sharedPreferences =
                                                getActivity().getSharedPreferences(getString(R.string.USER_EMAIL), Context.MODE_PRIVATE);
                                        sharedPreferences
                                                .edit()
                                                .putString(getString(R.string.USER_EMAIL), email)
                                                .apply();
                                        sharedPreferences =
                                                getActivity().getSharedPreferences(getString(R.string.FIREBASE_UID), Context.MODE_PRIVATE);
                                        sharedPreferences
                                                .edit()
